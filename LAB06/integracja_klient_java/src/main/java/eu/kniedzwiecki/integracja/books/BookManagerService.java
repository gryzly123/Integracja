 ...
 * 
 */
@WebServiceClient(name = "BookManagerService", targetNamespace = "http://books.integracja.kniedzwiecki.eu/", wsdlLocation = "http://localhost:666/books?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKMANAGERSERVICE_QNAME = new QName("http://books.integracja.kniedzwiecki.eu/", "BookManagerService");
    ...
    public BookManager getBookManagerPort() {
        return super.getPort(new QName("http://books.integracja.kniedzwiecki.eu/", "BookManagerPort"), BookManager.class);
    }
    ...
    public BookManager getBookManagerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://books.integracja.kniedzwiecki.eu/", "BookManagerPort"), BookManager.class, features);
    }
